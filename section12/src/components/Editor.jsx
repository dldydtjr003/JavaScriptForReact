  ...
  return (<>
    <div className="Editor"> 
      <section className="date_section"> 
        <h4>오늘의 날짜</h4> 
        <input type="date" name="createdDate" onChange={onChangeDate} value={getStringDate(createdDate)}/> 
      </section> 
      ...
      <section className="content_section"> 
        <h4>오늘의 일기</h4> 
        <textarea placeholder="오늘은 어땠나요?" onChange={onChangeContent} name="content" value={content}/> 
      </section> 
